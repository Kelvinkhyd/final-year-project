...
exports.UniversalAcceptanceEngine = void 0;
const punycode_1 = __importDefault(require("punycode"));
class UniversalAcceptanceEngine {
    static normalizeAndParse(rawEmail) {
            ...
            if (/[^\x00-\x7F]/.test(normalizedDomain)) {
                ...
                const converted = labels.map(label => {
                    ...
                    if (/[^\x00-\x7F]/.test(label)) {
                        try {
                            return punycode_1.default.toASCII(label);
                        }
                        catch {
...
exports.UniversalAcceptanceEngine = UniversalAcceptanceEngine;
